  ...
  return (
    <div className="flex items-center h-full ml-52 mr-52" >
      ...
      <div className="relative w-full z-2 mb-16">
        ...
        <div className="bg-[#ffffff11] h-full text-[#fff] font-medium text-lg py-12 px-16 rounded-3xl mr-32 ">
          <div className="gap-y-2 flex flex-col">
            ...
            <Input className="bg-[#fff] mb-3" placeholder="University Course" />
            ...
            <Input className="bg-[#fff] mb-3" placeholder="Marketting" />
            <p>Completion Year:</p>
            <Input className="bg-[#fff] mb-3" placeholder="2027" />
            <p>Enter your university name:</p>
            <Input className="bg-[#fff] mb-6" placeholder="JNU" />
            <div className="flex w-full justify-end">
              <Button className="bg-red-500 w-fit">Next</Button>
            </div>
          </div>
        </div>
      ...
      <Image
        ...
        className="absolute w-full h-full -right-72 z-1"
      />
    </div>
  );
}
